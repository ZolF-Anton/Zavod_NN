...
import { row, li, ol, col, h5Privacy, descr, h4Privacy } from './privacyx.module.scss';
            ...
            <div className={row}>
                <div className={col}>
                    <div id='inputResult'>
                        ...
                        <div className={row}>
                            <div className={col}>
                                <h5 className={h5Privacy}>1. Общие положения</h5>
                                <div className={descr}>
                                    ...
                                    предпринимаемые Заводом автомобильных ГЛУШИТЕЛЕЙ «КД» и «ТДГ»
                                    (далее – Оператор).
                                </div>
                                <div className={ol}>
                                    <div className={li}>
                            ...
                            <div className={col}>
                                ...
                                <div className={ol}>
                                    ...
                                    <div className={li}>
                                        ...
                                        сервисов интернет-статистики (Яндекс Метрика и/или Гугл
                                        Аналитика и других).
                                    </div>
                                    <div className={li}>
                                    ...
                                    <div className={li}>
                                        ...
                                        данных, указанных в ч. 1 ст. 10 Закона о персональных
                                    ...
                                    <div className={li}>
                                        ...
                                        этом соблюдаются условия, предусмотренные, в частности, ст.
                                        10.1 Закона о персональных данных. Требования к содержанию
                                        такого согласия устанавливаются уполномоченным органом по
                                    ...
                                    <div className={li}>
                                        ...
                                        (при наличии), контактную информацию (номер телефона, адрес
                                        электронной почты или почтовый адрес) субъекта персональных
                                        данных, а также перечень персональных данных, обработка
                                        которых подлежит прекращению. Указанные в данном требовании
                                        персональные данные могут обрабатываться только Оператором,
                        ...
                        <div className={row}>
                            <div className={col}>
                                <h5 className={h5Privacy}>7. Цели обработки персональных данных</h5>
                                <div className={ol}>
                                    <div className={li}>
                                    ...
                                    <div className={li}>
                                        ...
                                        Оператору письмо на адрес электронной почты DDobrota@mail.ru
                            ...
                            <div className={col}>
                                ...
                                <div className={ol}>
                                    ...
                                    <div className={li}>
                                        ...
                                        сайте https://zavod-kd.ru/ или направленные Оператору
                                        посредством электронной почты. Заполняя соответствующие
                        ...
                        <div className={row}>
                            <div className={col}>
                                <h5 className={h5Privacy}>14. Заключительные положения</h5>
                                <div className={ol}>
                                    <div className={li}>
